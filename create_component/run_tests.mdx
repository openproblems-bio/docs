...
``` text
Running tests in temporary directory: '/tmp/viash_test_logistic_regression_11303380346673462902'
====================================================================
+/tmp/viash_test_logistic_regression_11303380346673462902/build_engine_environment/logistic_regression ---verbosity 6 ---setup cachedbuild ---engine docker
[notice] Building container 'ghcr.io/openproblems-bio/task_template/methods/logistic_regression:test' with Dockerfile
[info] docker build -t 'ghcr.io/openproblems-bio/task_template/methods/logistic_regression:test'  '/tmp/viash_test_logistic_regression_11303380346673462902/build_engine_environment' -f '/tmp/viash_test_logistic_regression_11303380346673462902/build_engine_environment/tmp/dockerbuild-logistic_regression-FrFIsP/Dockerfile'
...
#6 writing image sha256:57745e2a8c28e2e92cea90279f6f9a821462048aa085893631f59c6238d1489e done
#6 naming to ghcr.io/openproblems-bio/task_template/methods/logistic_regression:test done
#6 DONE 0.0s
====================================================================
+/tmp/viash_test_logistic_regression_11303380346673462902/test_run_and_check_output/test_executable
>> Running test 'run'
...
====================================================================
+/tmp/viash_test_logistic_regression_11303380346673462902/test_check_config/test_executable
Load config data
Check .namespace
Check .info.type
