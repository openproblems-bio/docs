...
description: >-
  Information about branch naming convetion in Openproblems repository and
  forks.
order: 40
---
...
-   `hotfix` is for changing code with a temporary solution and/or
    without following the usual process (usually because of an
    emergency)
